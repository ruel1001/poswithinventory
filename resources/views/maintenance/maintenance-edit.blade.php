            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <form class="needs-validation" novalidate action="/maintenance/{{ $maintenance->maintenance_id}}"
                            method="POST">
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                            ...
                            <div class="form-group">
                                <div class="card-body">
                                    {!! QrCode::size(150)->generate($maintenance->maintenance_id) !!}
                                </div>
                                @error('account_name')
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <select name="material_uses" id="material_uses"
                                                class="form-control @error('material_used') is-invalid @enderror"
                                                required>
                                                <option    value="{{old('material_uses')}}" >Select Material Used</option>
                                            </select>
                                            @error('material_uses')
                                            <span class="invalid-feedback text-danger">{{ $message }}</span>
                                            @enderror
                                    ...
                                    $(document).ready(function() {
                                        ...
                                        $.ajax({
                                            ...
                                            success: function(data) {
                                                ...
                                                var selectedValue =
                                                    '{{ old("material_used", $maintenance->material_used) }}';
                                                // Set the selected option
                                                $('#material_used').val(selectedValue);
                                            },
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="material_id" readonly
                                                ...
                                                placeholder="Material ID" value="{{old('material_id',$maintenance->material_id)}}"
                                                required>
                                            @error('material_id')
                                            <span class="invalid-feedback text-danger">{{ $message }}</span>
                                            @enderror
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="material_quantity_used"
                                                ...
                                                placeholder="Quantity Used"  value="{{old('material_quantity_used',$maintenance->material_quantity_used)}}"
                                                required>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <textarea name="nature_of_repair" id="nature_of_repair"
                                                ...
                                                cols="10" rows="5"
                                                placeholder="Nature of Repair">{{old('nature_of_repair',$maintenance->nature_of_repair )}}</textarea>
