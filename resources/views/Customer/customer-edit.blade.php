            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <form class="needs-validation" novalidate action="/customer/{{ $customer->account_number}}"
                            method="POST">
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                            ...
                            <div class="form-group">
                                <div class="card-body">
                                    {!! QrCode::size(150)->generate($customer->account_number) !!}
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="date_plan"
                                                ...
                                                id="date_plan" placeholder="Date Plan"
                                                value="{{old('date_plan', $customer->date_plan)}}" required>
                                            @error('date_plan')
                                            <span class="invalid-feedback text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="amount_of_installation"
                                                ...
                                                value="{{old('amount_of_installation', $customer->amount_of_installation)}}"
                                                required>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="arrears"
                                                ...
                                                placeholder="Arrears" value="{{old('arrears', $customer->arrears)}}"
                                                required>
                                            @error('arrears')
                                            <span class="invalid-feedback text-danger">{{ $message }}</span>
                                            @enderror
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="foc"
                                                ...
                                                placeholder="foc" value="{{old('foc', $customer->foc)}}" required>
                                            @error('foc')
                                            <span class="invalid-feedback text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="modem"
                                                ...
                                                placeholder="Modem" value="{{old('modem', $customer->modem)}}" required>
                                            @error('modem')
                                            <span class="invalid-feedback text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="connector"
                                                ...
                                                value="{{old('connector', $customer->connector)}}" required>
                                            @error('connector')
                                            <span class="invalid-feedback text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="ficamp"
                                                ...
                                                placeholder="FICAMP" value="{{old('ficamp', $customer->ficamp)}}"
                                                required>
                                            @error('ficamp')
                                            <span class="invalid-feedback text-danger">{{ $message }}</span>
                                            @enderror
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="others"
                                                ...
                                                placeholder="Others" value="{{old('others', $customer->others)}}"
                                                required>
                                            @error('others')
                                            <span class="invalid-feedback text-danger">{{ $message }}</span>
                                            @enderror
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="messenger"
                                                ...
                                                id="messenger" placeholder="Messenger"
                                                value="{{old('messenger', $customer->messenger)}}" required>
                                            @error('messenger')
                                            <span class="invalid-feedback text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="area"
                                                ...
                                                placeholder="Area" value="{{old('area', $customer->area)}}" required>
                                            @error('area')
                                            <span class="invalid-feedback text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
